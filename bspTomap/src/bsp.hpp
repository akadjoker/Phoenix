...
private:
    ...
    void loadTexture(FileStream& file);
    void loadLightmap(FileStream& file);
    void loadVertex(FileStream& file);
    void loadFaces(FileStream& file);
    void loadIndex(FileStream& file);
    void LoadEntities(FileStream& file);
    void loadModels(FileStream& file);
